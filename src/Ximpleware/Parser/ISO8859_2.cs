		...
		{
			{
				...
				chars[0xA1] = (char) (0x0104); //	LATIN CAPITAL LETTER A WITH OGONEK
				...
				chars[0xA5] = (char) (0x013D); //	LATIN CAPITAL LETTER L WITH CARON
				chars[0xA6] = (char) (0x015A); //	LATIN CAPITAL LETTER S WITH ACUTE
				chars[0xA7] = (char) (0x00A7); //	SECTION SIGN
				chars[0xA8] = (char) (0x00A8); //	DIAERESIS
				chars[0xA9] = (char) (0x0160); //	LATIN CAPITAL LETTER S WITH CARON
				chars[0xAA] = (char) (0x015E); //	LATIN CAPITAL LETTER S WITH CEDILLA
				chars[0xAB] = (char) (0x0164); //	LATIN CAPITAL LETTER T WITH CARON
				chars[0xAC] = (char) (0x0179); //	LATIN CAPITAL LETTER Z WITH ACUTE
				chars[0xAD] = (char) (0x00AD); //	SOFT HYPHEN
				chars[0xAE] = (char) (0x017D); //	LATIN CAPITAL LETTER Z WITH CARON
				chars[0xAF] = (char) (0x017B); //	LATIN CAPITAL LETTER Z WITH DOT ABOVE
				chars[0xB0] = (char) (0x00B0); //	DEGREE SIGN
				chars[0xB1] = (char) (0x0105); //	LATIN SMALL LETTER A WITH OGONEK
				chars[0xB2] = (char) (0x02DB); //	OGONEK
				chars[0xB3] = (char) (0x0142); //	LATIN SMALL LETTER L WITH STROKE
				chars[0xB4] = (char) (0x00B4); //	ACUTE ACCENT
				chars[0xB5] = (char) (0x013E); //	LATIN SMALL LETTER L WITH CARON
				chars[0xB6] = (char) (0x015B); //	LATIN SMALL LETTER S WITH ACUTE
				chars[0xB7] = (char) (0x02C7); //	CARON
				chars[0xB8] = (char) (0x00B8); //	CEDILLA
				chars[0xB9] = (char) (0x0161); //	LATIN SMALL LETTER S WITH CARON
				chars[0xBA] = (char) (0x015F); //	LATIN SMALL LETTER S WITH CEDILLA
				chars[0xBB] = (char) (0x0165); //	LATIN SMALL LETTER T WITH CARON
				chars[0xBC] = (char) (0x017A); //	LATIN SMALL LETTER Z WITH ACUTE
				chars[0xBD] = (char) (0x02DD); //	DOUBLE ACUTE ACCENT
				chars[0xBE] = (char) (0x017E); //	LATIN SMALL LETTER Z WITH CARON
