...
namespace com.ximpleware.parser
{
	...
	/// <summary> this class contains method to map a windows-1258 char
	/// into a Unicode char
	/// 
	/// </summary>
		...
		{
			{
				...
				chars[0xCC] = (char) (0x0300); // COMBINING GRAVE ACCENT
				...
				chars[0xDD] = (char) (0x01AF); // LATIN CAPITAL LETTER U WITH HORN
				chars[0xDE] = (char) (0x0303); // COMBINING TILDE
				...
				chars[0xEC] = (char) (0x0301); // COMBINING ACUTE ACCENT
				...
				chars[0xFD] = (char) (0x01B0); // LATIN SMALL LETTER U WITH HORN
				chars[0xFE] = (char) (0x20AB); // DONG SIGN
