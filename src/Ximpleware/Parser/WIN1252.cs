...
namespace com.ximpleware.parser
{
	...
	/// <summary> this class contains method to map a windows-1252 char
	/// into a Unicode char
	/// 
	/// </summary>
		...
		{
			{
				...
				chars[0xD0] = (char) (0x00D0); // LATIN CAPITAL LETTER ETH
				...
				chars[0xDE] = (char) (0x00DE); // LATIN CAPITAL LETTER THORN
				...
				chars[0xF0] = (char) (0x00F0); // LATIN SMALL LETTER ETH
				...
				chars[0xFE] = (char) (0x00FE); // LATIN SMALL LETTER THORN
