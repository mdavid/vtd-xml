...
namespace com.ximpleware.parser
{
	...
	/// <summary> this class contains method to map a ISO-8859-10 char
	/// into a Unicode char
	/// 
	/// </summary>
		...
		{
			{
				...
				chars[0xA2] = (char) (0x0112);
				chars[0xA3] = (char) (0x0122);
				chars[0xA4] = (char) (0x012A);
				chars[0xA5] = (char) (0x0128);
				chars[0xA6] = (char) (0x0136);
				chars[0xA7] = (char) (0x00A7);
				chars[0xA8] = (char) (0x013B);
				chars[0xA9] = (char) (0x0110);
				chars[0xAA] = (char) (0x0160);
				chars[0xAB] = (char) (0x0166);
				chars[0xAC] = (char) (0x017D);
				chars[0xAD] = (char) (0x00AD);
				chars[0xAE] = (char) (0x016A);
				chars[0xAF] = (char) (0x014A);
				chars[0xB0] = (char) (0x00B0);
				chars[0xB1] = (char) (0x0105);
				chars[0xB2] = (char) (0x0113);
				chars[0xB3] = (char) (0x0123);
				chars[0xB4] = (char) (0x012B);
				chars[0xB5] = (char) (0x0129);
				chars[0xB6] = (char) (0x0137);
				chars[0xB7] = (char) (0x00B7);
				chars[0xB8] = (char) (0x013CA);
				chars[0xB9] = (char) (0x0111);
				chars[0xBA] = (char) (0x0161);
				chars[0xBB] = (char) (0x0167);
				chars[0xBC] = (char) (0x017E);
				chars[0xBD] = (char) (0x2015);
				chars[0xBE] = (char) (0x016B);
